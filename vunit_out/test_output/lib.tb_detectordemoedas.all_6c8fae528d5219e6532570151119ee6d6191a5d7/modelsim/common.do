...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/modelsim/modelsim.ini -wlf {/home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/test_output/lib.tb_detectordemoedas.all_6c8fae528d5219e6532570151119ee6d6191a5d7/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_detectordemoedas/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/test_output/lib.tb_detectordemoedas.all_6c8fae528d5219e6532570151119ee6d6191a5d7/,tb path : /home/borg/Desktop/projet1/Z01.1-Hersheys/Projetos/B-LogicaCombinacional/testes/,use_color : true"} lib.tb_detectordemoedas(tb)   -L vunit_lib -L lib}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/modelsim/modelsim.ini -wlf {/home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/test_output/lib.tb_detectordemoedas.all_6c8fae528d5219e6532570151119ee6d6191a5d7/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_detectordemoedas/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/test_output/lib.tb_detectordemoedas.all_6c8fae528d5219e6532570151119ee6d6191a5d7/,tb path : /home/borg/Desktop/projet1/Z01.1-Hersheys/Projetos/B-LogicaCombinacional/testes/,use_color : true"} lib.tb_detectordemoedas(tb)   -L vunit_lib -L lib' failed
...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Desktop/projet1/Z01.1-Hersheys/vunit_out/test_output/lib.tb_detectordemoedas.all_6c8fae528d5219e6532570151119ee6d6191a5d7/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {/bin/python3 -u /home/borg/Desktop/projet1/Z01.1-Hersheys/Projetos/B-LogicaCombinacional/testeLogicaCombinacional.py --compile}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/bin/python3', '-u', '/home/borg/Desktop/projet1/Z01.1-Hersheys/Projetos/B-LogicaCombinacional/testeLogicaCombinacional.py', '--compile'], cwd='/home/borg/Desktop/projet1/Z01.1-Hersheys', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
